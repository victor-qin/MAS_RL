...
def main():
    ...
    ##### Config Stuff
    group_temp = "033021-8_max-kappa0.95"
    env_id = 'Pendulum-v0' 
    # env_id = 'gym_quad-v0'
    ...
    wandb.run.notes ="max weighting, kappa 0.95, for 8 agent case pendulum, 64 net, final presentation"
    ...
    wandb.config.kappa = 0.95      # range 1 (all avg) to 0 (no avg)
